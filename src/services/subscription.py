...
from src.utils.crypto import DEFAULT_TLS_DOMAIN, build_proxy_link, build_proxy_link_https
...
class SubscriptionService:
    ...
    Attributes:
        ...
        _tls_domain: Домен-маскировка для fake-TLS ссылок.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            tls_domain: Домен-маскировка для ee-ссылок.
        """
