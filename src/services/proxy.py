...
def get_proxy_usage_rules() -> str:
    ...
    return (
        ...
        "и добавьте новый.\n\n"
        "<b>🔒 Для MTProto:</b>\n"
        "• Внутренний протокол Telegram — сложнее заблокировать.\n"
        "• Может работать медленнее из-за шифрования.\n"
        "• Не используйте одновременно с VPN на всю систему.\n"
        "• Первое подключение может занимать до 1 минуты.\n"
        "• Используйте один активный прокси-профиль.\n\n"
        "<b>🧦 Для SOCKS5:</b>\n"
        "• Универсальный протокол — работает быстрее.\n"
        "• Идеально подходит для телефонов и любых сетей.\n"
        "• Вводите данные (IP, порт, логин, пароль) в настройках Telegram "
